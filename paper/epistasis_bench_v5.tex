...
H2 and HA5 are compatible: higher truncation order captures
additional variance (confirming H2) that is orthogonal to the
pairwise Walsh subspace and therefore invisible to detection
(falsifying HA5). Proposition~\ref{prop:invariance} formalizes why.
